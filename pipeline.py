...
class Pipeline:
    def __init__(self, hparams):
        ...
        # reshape style image into the shape (1, 3, 256, 256)
        self.style_image = Image.open('style.jpg')
        self.style_image = self.style_image.resize((256, 256), Image.LANCZOS)
        ...
        self.style_image = torch.unsqueeze(self.style_image, 0)
    ...
    def training_data_setup(self):
        if self.is_learning_density:
            self.kwargs['img_wh'] = tuple(hparams.img_wh)
