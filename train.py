...
class NeRFSystem(LightningModule):
    def __init__(self, hparams):
        ...
        if hparams.encode_a:  # whether to use appearance embeddings
            """
            torch.nn.Embeddings acts like a lookup table. In this case, we store <hparams.N_vocab> embeddings of length 
            <hparams.N_a> which will be our appearance embeddings to be optimized for each training image. N_a is 48 by 
            default. We would probably use lower dimensions to explore the latent space.
            """
